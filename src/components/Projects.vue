    ...
    <div class="projects__container container--fluid">
      ...
      <div class="row">
        ...
        <div class="projects__info column-mobile--12 column--8">
          ...
          <a href="https://glueckkanja.com/"><h3 class="projects__link">CloudBoot</h3></a>
          ...
          <p>For this project I developed the client and server side. The client is embedded inside an USB stick from which users boot into the application. The customer can install any operating system of their choice and has the convenience of pre-configured custom operating system images. An operating system installs unattended over the internet and optional configuration is possible through the client.</p>
        </div>
      </div>
      <div class="row">
        <div class="column--2 projects__offset">
        ...
        <div class="projects__info column-mobile--12 column--8">
          ...
          <a href="http://www.rmsviewer.com/"><h3 class="projects__link">RMS Viewer</h3></a>
